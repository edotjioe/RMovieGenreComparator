  ...
  tabItems(
             ...
             fluidRow(
               ...
               column( width = 3,
                       box(
                         ...
                         width = 12,
                         status = "warning",
                         selectInput("xcolp1", "Select dataset", c("Average rating" = "avg_rating", "Total movies" = "total_movies", "Total votes" = "total_votes"))
                       ),
                       box(
                         collapsible = TRUE,
                         width = 12,
    ...
    tabItem( tabName = "timechart",
             ...
             box(
               ...
               status = "warning",
               width = 3,
               selectInput("genrep3", "Select genre", unique(genres$name), multiple = TRUE, selected = "Crime"),
...
ui <- dashboardPage( skin = "green",
                     ...
                     dashboardSidebar( width = 300,
                                       sidebarMenu( id = "sidebar",
                                                    menuItem("Barchart", tabName = "barplot", icon = icon("bar-chart-o")),
                                                    menuItem("Piechart", tabName = "piechart", icon = icon("pie-chart")),
                                                    menuItem("Timechart", tabName = "timechart", icon = icon("line-chart")),
